                ...
                <table class = "table table-bordered" border="1">
                    ...
                    <?php
                        $sql = "SELECT id, nome, cpf, rg, date_format(nasc, '%d-%m-%Y'), sexo, telefone, celular, email, rua, bairro,"
                                . "numero, complemento, cep,estado, cidade, placa, funcao FROM funcionario where id='".$_GET['id']."'";
                    ...
                    ?>
                     <tr>
                                ...
                                <td><?php echo mb_strtoupper($row["nome"]); ?></td>
                    ...
                    <tr>
                        ...
                        <th class = "alert alert-warning">PLACA</th>
                        ...
                        <th class = "alert alert-warning">EXCLUIR</th>
                            ...
                            <tr>
                                ...
                                <td><?php echo mb_strtoupper($row["funcao"]); ?></td>
                                 <td><?php echo"<a href='editarFuncionario.php?id=".$row["id"]."'><img src='images/editar.png'></img></a>";?></td>
                                 <td><?php echo"<a href='excluirFuncionario.php?id=".$row["id"]."'><img src='images/cancelar.png'></img></a>";?></td>
                            </tr>
                    <?php 		
                        }
                        $connect->close();
